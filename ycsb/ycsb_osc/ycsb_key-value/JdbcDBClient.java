...
// store field:value in dictionary
      HashMap<String, String> fieldValues = new HashMap<String, String>();
      do {
        fieldValues.put(resultSet.getString("ATTRIBUTE_KEY"), resultSet.getString("VALUE"));
...
// put result
  ...
  public Status scan(String tableName, String startKey, int recordcount, Set<String> fields,
    ...
    try {
      ...
      scanStatement.setInt(2, recordcount*10);
      ...
      for (int i = 0; i < recordcount && resultSet.next(); i++) {
        if (result != null && fields != null) {
          ...
          for (String field : fields) {
            ...
            String fie = resultSet.getString("ATTRIBUTE_KEY");
            values.put(fie, new StringByteIterator(value));
          }
          result.add(values);
        }
      }
  ...
  public Status insert(String tableName, String key, HashMap<String, ByteIterator> values) {
    try {
      ...
      int index = 1;
      for (String value: fieldInfo.getFieldValues()) {
        insertStatement.setString(index++, key);
